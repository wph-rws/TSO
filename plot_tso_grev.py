...
However, you can adjust this by using the 'multiple_offset' parameter to select a different set of six consecutive measurements. For example:
    ...
    - Similarly, 'multiple_offset = 7' will select the six measurements starting from the seventh-most recent, and so on.
"""
...
location = 'grev'
process_plots(location, plot_mode='multiple', multiple_offset=5)
